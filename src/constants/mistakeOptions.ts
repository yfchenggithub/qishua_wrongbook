...
export const MODULE_OPTIONS = [
  { id: '1', value: '函数', label: '函数' },
  { id: '2', value: '数列', label: '数列' },
  { id: '3', value: '导数', label: '导数' },
  { id: '4', value: '圆锥曲线', label: '圆锥曲线' },
  { id: '5', value: '立体几何', label: '立体几何' },
  { id: '6', value: '平面几何', label: '平面几何' },
  { id: '7', value: '三角函数', label: '三角函数' },
  { id: '8', value: '概率统计', label: '概率统计' },
  { id: '9', value: '不等式', label: '不等式' },
  { id: '10', value: '其他', label: '其他' },
] as const satisfies readonly MistakeOption<string>[];
