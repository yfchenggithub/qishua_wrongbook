...
以下区间的原始正文在历史中发生编码损坏，先按 Git 提交标题补回索引，后续可按需逐条补全细节：

- 2026-05-08 - 阶段 4-G：/dev/images 图片调试页 (hash: 7447f62)
- 2026-05-08 - 阶段 4-H：统一验收、文档更新、轻量清理 (hash: 09ef795)
- 2026-05-08 - 阶段 5-B：表单类型、选项常量、校验规则 (hash: 7f0cbfd)
- 2026-05-08 - 阶段 5-C：CreateMistakeService，封装保存业务 (hash: b7da8dd)
- 2026-05-08 - 阶段 5-D：新增页接入表单状态和图片选择，但暂不保存 (hash: 92ebfaa)
- 2026-05-08 - 阶段 5-E：新增页接入保存错题 (hash: 3c92d39)
- 2026-05-08 - 阶段 5-F：保存体验、异常处理、防重复、草稿清理 (hash: d2f4e78)
- 2026-05-08 - 阶段 5-G：开发验收页或联合验收 (hash: 81c06f6)
- 2026-05-08 - 阶段 5-H：统一验收、文档更新、轻量清理 (hash: d260bf0)
- 2026-05-08 - 阶段 6-B：Repository 查询能力增强 (hash: 823b13a)
- 2026-05-08 - 阶段 6-C：错题列表 ViewModel / Service (hash: 097b83e)
- 2026-05-08 - 阶段 6-D：题库页接入 SQLite 真实列表 (hash: 844acf0)
- 2026-05-08 - 阶段 6-E：搜索、筛选、排序接入 (hash: 9d86594)
- 2026-05-08 - 阶段 6-E：搜索、筛选、排序接入 (hash: df5c437)
- 2026-05-08 - 阶段 6-G：首页“错题队列 / 今日待复做”轻量接入真实数据 (hash: c952785)
- 2026-05-08 - 阶段 6-H：统一验收、文档更新、轻量清理 (hash: 6d8587b)
- 2026-05-08 - 阶段 7-B：详情页 ViewModel / DetailService (hash: 1b6fe2b)
- 2026-05-08 - 阶段 7-C：详情页读取真实 id 和真实数据 (hash: 1c97cee)
- 2026-05-08 - 阶段 7-D：图片预览组件完善 (hash: b248e7f)
- 2026-05-08 - 阶段 7-E：详情页状态完善 (hash: 3983e5a)
- 2026-05-08 - 阶段 7-F：跳转入口一致性检查 (hash: 713ffe6)
- 2026-05-08 - 阶段 7-G：开发调试能力增强 (hash: f2307f4)
- 2026-05-08 - 阶段8-B：复做服务层闭环（事务一致性） (hash: d9d2711)
- 2026-05-08 - 阶段8-C：复做页 UI 与提交交互 (hash: 4d1ead7)
- 2026-05-08 - 阶段8-D：详情 / 首页 / 题库联动刷新与 Android 回归 (hash: 06757a0)
- 2026-05-08 - 阶段8-E：最终验收与轻量清理 (hash: e15d32a)
- 2026-05-08 - 阶段9-A：补关键日志与错误提示 (hash: 5053aeb)
- 2026-05-08 - 阶段9-B：增强现有 /dev/db 调试页 (hash: 3d0e8f3)
- 2026-05-09 - 阶段10-A：设置页 Tab 与基础页面 (hash: 40746c7)
- 2026-05-09 - 阶段 10-B：设置页静态 UI (hash: 92c56d8)
- 2026-05-09 - 阶段 10-C：点击版本号 7 次解锁开发模式 (hash: f5b3e15)
- 2026-05-09 - 阶段 10-D：解锁后显示 /dev/db 和 /dev/images 入口 (hash: 26612e6)
- 2026-05-09 - 阶段10-E：本地数据概况卡片 (hash: 295433d)
- 2026-05-09 - [fix] 发布后也可以用，不限制 __DEV__ 才能解锁 (hash: 79d5bf9)
- 2026-05-13 - 更新开发文档 (hash: 5d2221a)
